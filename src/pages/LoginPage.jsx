...
import { FaShieldAlt, FaArrowRight, FaGoogle, FaEnvelope, FaLock, FaFingerprint } from "react-icons/fa";
...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      // NOTE: Ensure your AuthContext uses API_BASE internally for these calls
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 md:p-8 relative selection:bg-fuchsia-500/40 overflow-hidden">
      ...
      {/* SUCCESS OVERLAY - Adaptive Scaling */}
      <AnimatePresence>
        {isVerified && (
          <motion.div
            initial={{ opacity: 0 }}
