...
export default function Navbar({ userData }) {
    ...
    return (
        // Changed bg-black/40 to a more neutral backdrop-blur that adapts better
        <nav className="sticky top-0 z-[500] w-full border-b border-white/10 bg-black/20 backdrop-blur-xl transition-all duration-500">
                        ...
                        <AnimatePresence>
                            {dropdownOpen && (
                                <motion.div 
                                    ...
                                    // Removed hardcoded hex #0c0c0c for a transparent dark blur
